...
**floria** performs strain/haplotype phasing on short-read or long-read whole genome metagenomic samples. See https://phase-doc.readthedocs.io/en/latest/index.html for more information.
