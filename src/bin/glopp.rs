...
fn main() {
    ...
    let matches = Command::new("glopp")
                          ...
                          .arg(Arg::new("epsilon")
                              ...
                              .takes_value(true)
                              .value_name("FLOAT")
                              .help("Estimated allele call error rate. (default: 0.04 without -H, 0.03 with -H. If using short reads/hifi, try -e 0.01.)")
                        ...
                        .arg(Arg::new("trace")
                          ...
                          .arg(Arg::new("use_qual_scores")
                           ...
                           .arg(Arg::new("ploidy sensitivity")
                              ...
                              .takes_value(true)
                              .value_name("1,2,3")
                              .help("Controls how sensitive the local ploidy stopping heuristic is. Higher values try to phase more haplotypes, but may give more fragmented, erroneous haplotypes. (Default: 2)")
                              .help_heading(alg_options))
                          ...
                          .arg(Arg::new("trim")
                              .long("trim-reads")
                              .help("Trim output long-reads to lie within the haplotype block the read is assigned to. (default: don't trim reads)")
                              .help_heading(output_options))
